...
/**
 * Implementation of AgentLoggerExecutor interface to log stats on file.
 * 
 * @author Luigi Sportelli gigiozzz@gmail.com
 *
 */
@Component("fileLoggerExecutor")
public class FileLoggerExecutor implements AgentLoggerExecutor {

    private static final Logger logger = LoggerFactory.getLogger(FileLoggerExecutor.class);
